...
HF_PATH = "/home/mmorocho/teams/dsc-180a---a14-[88137]/bnpp_frontalonly_1024_"
SAVE_PATH = "/home/mmorocho/private/data/bnpp_224_pandas/"
...
def read_ins():
    ...
    test_df = pd.read_csv(
        "/home/mmorocho/teams/dsc-180a---a14-[88137]/BNPP_DT_test_with_ages.csv",
        usecols=cols,
    ).set_index("unique_key")
    train_df = pd.read_csv(
        "/home/mmorocho/teams/dsc-180a---a14-[88137]/BNPP_DT_train_with_ages.csv",
        usecols=cols,
    ).set_index("unique_key")
    val_df = pd.read_csv(
        "/home/mmorocho/teams/dsc-180a---a14-[88137]/BNPP_DT_val_with_ages.csv",
        usecols=cols,
    ).set_index("unique_key")
...
def save_files():
    ...
    for hf in hfs:
        ...
        np.array(file_paths).tofile(
            "/home/mmorocho/private/data/df_bnpp_datapaths.csv",
            sep=",",
        )
    np.array(keys).tofile("/home/mmorocho/private/data/df_bnpp_keys.csv", sep=",")
    pd.DataFrame({"filepath": file_paths, "keys": keys}).to_pickle(
        "/home/mmorocho/private/data/df_bnpp_datapaths.pandas"
    )
